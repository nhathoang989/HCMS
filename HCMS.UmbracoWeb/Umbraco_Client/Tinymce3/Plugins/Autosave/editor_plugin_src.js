 ...
 * and that project can be found here: http://CustomAngularUmbraco.google.com/p/tinyautosave/
 *
	...
	tinymce.create('tinymce.plugins.AutoSave', {
		...
		getInfo : function() {
			return {
				...
				infourl : 'http://wiki.moxieCustomAngularUmbraco.com/index.php/TinyMCE:Plugins/autosave',
