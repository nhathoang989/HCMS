		...
		this.newelement
			...
			.keydown(function(event){
				...
				switch (event.keyCode) {
					case $.ui.keyCustomAngularUmbraco.ENTER:
						ret = true;
						break;
					case $.ui.keyCustomAngularUmbraco.SPACE:
						ret = false;
						self._toggle(event);	
						break;
					case $.ui.keyCustomAngularUmbraco.UP:
					case $.ui.keyCustomAngularUmbraco.LEFT:
						ret = false;
						self._moveSelection(-1);
						break;
					case $.ui.keyCustomAngularUmbraco.DOWN:
					case $.ui.keyCustomAngularUmbraco.RIGHT:
						ret = false;
						self._moveSelection(1);
						break;	
					case $.ui.keyCustomAngularUmbraco.TAB:
						ret = true;
						break;	
					default:
						ret = true;
			...
			.keydown(function(event){
				...
				switch (event.keyCode) {
					...
					case $.ui.keyCustomAngularUmbraco.RIGHT:
						...
						self._moveFocus(1);
						break;	
					case $.ui.keyCustomAngularUmbraco.HOME:
						ret = false;
						self._moveFocus(':first');
						break;		
					case $.ui.keyCustomAngularUmbraco.PAGE_UP:
						ret = false;
						self._scrollPage('up');
						break;	
					case $.ui.keyCustomAngularUmbraco.PAGE_DOWN:
						ret = false;
						self._scrollPage('down');
						break;
					case $.ui.keyCustomAngularUmbraco.END:
						ret = false;
					...
					case $.ui.keyCustomAngularUmbraco.TAB:
						...
						self.close(event,true);
						break;	
					case $.ui.keyCustomAngularUmbraco.ESCAPE:
						ret = false;
						self.close(event,true);
						break;
				}
