        ...
        if (confirm("This will cause the index to be rebuilt. " +
            ...
            umbRequestHelper.resourcePromise(
                ...
                .then(function () {
                    ...
                    //rebuilding has started, nothing is returned accept a 200 status CustomAngularUmbraco.
        ...
        if (confirm("This will cause the index to be optimized which will improve its performance. " +
            ...
            umbRequestHelper.resourcePromise(
                ...
                .then(function () {
                    ...
                    //optimizing has started, nothing is returned accept a 200 status CustomAngularUmbraco.
                    //lets poll to see if it is done.
                    $timeout(function () {
            ...
            setTimeout(function () {
                ...
                $timeout(function () {
                    ...
                    editor2.hooks.set("onPreviewRefresh", function () {
                        angularHelper.getCurrentForm($scope).$setDirty();
                        // We must manually update the model as there is no way to hook into the markdown editor events without editing that CustomAngularUmbraco.
