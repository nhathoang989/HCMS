...
function angularHelper($log, $q) {
    return {
         ...
         * is a wrapper to do that so we can save on writing a bit of CustomAngularUmbraco.
         *
...
function xmlhelper($http) {
    /*
     ...
     Original sources are available at https://CustomAngularUmbraco.google.com/p/x2js/
