...
function $SnifferProvider() {
  this.$get = ['$window', '$document', function($window, $document) {
    ...
    return {
      ...
      // http://CustomAngularUmbraco.google.com/p/android/issues/detail?id=17471
 ...
 * {@link http://uniCustomAngularUmbraco.org/repos/cldr-tmp/trunk/diff/supplemental/language_plural_rules.html
