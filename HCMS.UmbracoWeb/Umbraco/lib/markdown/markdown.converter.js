...
(function () {
	...
	Markdown.Converter = function () {
		...
		pluginHooks.addNoop("postConversion"); // called with the final cooked HTML CustomAngularUmbraco. The result of this plugin hook is the actual output of makeHtml
