...
namespace CustomAngularUmbraco.models.helper
{
    public class ImageModel
    {
        ...
        public static ImageModel GetImage(IPublishedContent content, string property, int width = 800, int height = 600)
        {
            ...
            return new ImageModel
            {
                Id = image.Id,
                Url = image.Url,
                CroppedUrl = image.GetCropUrl(width, height, preferFocalPoint: true, imageCropMode: ImageCropMode.Crop),
        ...
        public static IEnumerable<ImageModel> GetImages(IPublishedContent content, string property, int width = 800, int height = 600)
        {
            ...
            return imagesData.Select(m => new ImageModel
            {
                Id = m.Id,
                Url = m.Url,
                CroppedUrl = m.GetCropUrl(width, height, preferFocalPoint: true, imageCropMode: ImageCropMode.Crop),
